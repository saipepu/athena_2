...
const Dashboard = () => {
  ...
  const EmployeeDashboard = () => {
    ...
    return (
        <HStack
          minWidth="800px" width="100%" maxWidth="1000px" height="160px"
          spacing={'24px'} padding="24px">
            <Card height="100%" bgColor="white" flex="1" minWidth="260px" direction={'row'} alignItems='center' justifyContent='flex-start' padding="12px 24px" borderRadius="8px" boxShadow="0px 6px 15px -5px rgba(0, 0, 0, 0.15)" border="0.5px solid #00000010">
              <Image src={red_clock} objectFit="contain" alt="red_clock"/>
                <CardBody padding="12px">
                  ...
                  <Text as="p" fontSize={'36px'} lineHeight="100%" whiteSpace="none">{employee?.hr_of_training}</Text>
                </CardBody>
            </Card>
            <Card height="100%" bgColor="white" flex="1" minWidth="260px" direction={'row'} alignItems='center' justifyContent='flex-start' padding="12px 24px" borderRadius="8px" boxShadow="0px 6px 15px -5px rgba(0, 0, 0, 0.15)" border="0.5px solid #00000010">
              <Image src={token} objectFit="contain" alt="red_clock"/>
                <CardBody padding="12px">
                  ...
                  <Text as="p" fontSize={'36px'} lineHeight="100%" whiteSpace="none">{employee?.ATH}</Text>
                </CardBody>
            </Card>
            <Card height="100%" bgColor="white" flex="1" minWidth="260px" direction={'row'} alignItems='center' justifyContent='flex-start' padding="12px 24px" borderRadius="8px" boxShadow="0px 6px 15px -5px rgba(0, 0, 0, 0.15)" border="0.5px solid #00000010">
              <Image src={book} objectFit="contain" alt="red_clock"/>
                <CardBody padding="12px">
                  ...
                  <Text as="p" fontSize={'36px'} lineHeight="100%" whiteSpace="none">{employee?.exp}</Text>
                </CardBody>
            </Card>
          </HStack>
      )
      ...
      <HStack
        ...
        spacing={'24px'} padding="24px">
            <Card height="100%" bgColor="white" flex="1" minWidth="260px" direction={'row'} alignItems='center' justifyContent='flex-start' padding="12px 24px" borderRadius="8px" boxShadow="0px 6px 15px -5px rgba(0, 0, 0, 0.15)" border="0.5px solid #00000010">
                <Image src={book} objectFit="contain" alt="red_clock"/>
                <CardBody padding="12px">
                  <Heading fontSize={'16px'} fontWeight="normal" color="#A3AED0" whiteSpace="none">Employees</Heading>
                  <Text as="p" fontSize={'36px'} lineHeight="100%" whiteSpace="none">{numberOfEmployee}</Text>
                </CardBody>
            </Card>
            <Card height="100%" bgColor="white" flex="1" minWidth="260px" direction={'row'} alignItems='center' justifyContent='flex-start' padding="12px 24px" borderRadius="8px" boxShadow="0px 6px 15px -5px rgba(0, 0, 0, 0.15)" border="0.5px solid #00000010">
